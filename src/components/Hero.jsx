  ...
  return (
    <section id="inicio" className="en-verde relative bg-agua text-white overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-5 sm:px-8 pt-16 pb-28 md:pt-24 md:pb-40">
        <div className="grid lg:grid-cols-[1.35fr,minmax(280px,360px)] gap-10 lg:gap-16 lg:items-center">
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <a href="#unirse" className="btn btn-amber w-full sm:w-auto">Quiero ser defensor ↗</a>
              <a href="#acciones" className="btn btn-ghost text-white w-full sm:w-auto">Firmar y radicar</a>
            </div>
          </div>

          <div className="rounded-2xl border border-white/20 bg-white/10 backdrop-blur-md p-5 sm:p-6 divide-y divide-white/15">
            <div className="pb-4">
        ...
        <div className="mt-10 sm:mt-14 grid sm:grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3">
          {cards.map(([t, d], i) => (
            <div key={i} className="rounded-xl border border-white/20 bg-bosque-hondo/35 backdrop-blur-sm p-3 sm:p-4">
