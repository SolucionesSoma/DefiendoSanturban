...
const PREGUNTAS = [
  ...
  ['"¿Y la minería ilegal qué? De eso no dicen nada."', 'Revocar la reserva tampoco combate la minería ilegal: ninguna máquina ilegal se detiene porque desaparezca una resolución. Al contrario, el limbo le sirve. Y el Comité no guarda silencio: denunció ante la Fiscalía General de la Nación la minería ilegal en Santurbán. Defender el páramo es defenderlo de todas las máquinas, con título mínero o sin él.'],
